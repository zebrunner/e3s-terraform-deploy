<powershell>
    ...
    Initialize-ECSAgent -Cluster '${cluster_name}' -EnableTaskIAMRole -AwsvpcBlockIMDS -LoggingDrivers '["json-file","awslogs"]' -EnableTaskIAMRole -AwsvpcAdditionalLocalRoutes '["{cidr_block}"]'
